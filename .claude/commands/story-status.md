...
anything before Ready. If the card is at **Backlog** or not on the board, report that
implementation must not start and the card needs human review and Ready promotion —
