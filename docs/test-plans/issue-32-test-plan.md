...
| Silent round (claude exits 0 with no output) is a failed round too | Fixture: silent stub — exit 1 + "produced no review" on stderr + empty stdout (round-5 💬 finding, pinned) | automated — `make check-ai-review` |
